...
public class CampgroundUI {
	...
	Scanner theKeyboard = new Scanner(System.in);   // created a scanner object called the keyboard to scan whats being input
	
	/*******************************************************************************************************
	 * Class member variables, objects, constants and methods should be coded here.
	 ******************************************************************************************************/
	
 	public void displayBanner() {				// we created a method called display banner to display Welcome when the app is ran
	...
	public Park displayParksAndPick1(List<Park> Parks) { //a method to display parks and choose 1
