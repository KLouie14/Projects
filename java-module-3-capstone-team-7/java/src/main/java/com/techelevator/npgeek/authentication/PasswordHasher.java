...
public class PasswordHasher {
     ...
     * 
     * The SecretKeyFactory class is provided by Java to generate an encrypted
     * value using a KeySpec.
     * 
     * The generateSecret() method of the SecretKeyFactoy will return the encrypted value
     *     from a KeySpec
     *
